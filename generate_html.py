...
<head>
    <meta charset="utf-8">
    <title>The Buzz - Curated movie trailers</title>
      ...
      <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <a class="navbar-brand" href="#">The Buzz - Curated movie trailers</a>
          </div>
        </div>
      </div>
    </div>
...
<div class="col-md-6 col-lg-4 movie-tile text-center" data-trailer-youtube-id="{trailer_youtube_id}" data-toggle="modal" data-target="#trailer">
    ...
    <p>Directed by {movie_director}<br/>{movie_cast}<br/>{movie_rating} stars</p>
</div>
'''
